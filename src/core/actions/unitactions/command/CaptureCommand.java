    ...
    public boolean execute(Action a, GameState gs) {
        ...
        if (action.isFeasible(gs)) {
            ...
            if (captureType == Types.TERRAIN.CITY) {
                ...
                gs.getBoard().getDiplomacy().clearPendingOffersBetween(thisTribe.getTribeId(), targetTribe.getTribeId());
                gs.getBoard().getDiplomacy().setRelationship(thisTribe.getTribeId(), targetTribe.getTribeId(), Types.RELATIONSHIP.WAR, gs.getTick());
                gs.getBoard().destroyEmbassiesBetween(gs, thisTribe.getTribeId(), targetTribe.getTribeId());
