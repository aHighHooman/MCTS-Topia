...
public abstract class Unit extends Actor
{
    ...
    private boolean hiddenAtTurnStart;
    private boolean hiddenEnemyHint;
    ...
    public Unit(double atk, double def, int mov, int max_hp, int range, int cost, Vector2d pos, int kills, boolean isVeteran, int cityId, int tribeID){
        ...
        this.hidden = false;
        this.hiddenAtTurnStart = false;
        this.hiddenEnemyHint = false;
    }
    ...
    public int getCurrentHP(){
        return (int) Math.floor(currentHP);
    }

    public double getCurrentHPExact(){
        return currentHP;
    }
    ...
    public boolean wasHiddenAtTurnStart() {
        return hiddenAtTurnStart;
    }

    public void markTurnStart() {
        this.hiddenAtTurnStart = this.hidden;
    }

    public void setHiddenAtTurnStart(boolean hiddenAtTurnStart) {
        this.hiddenAtTurnStart = hiddenAtTurnStart;
    }

    public boolean hasHiddenEnemyHint() {
        return hiddenEnemyHint;
    }

    public void setHiddenEnemyHint(boolean hiddenEnemyHint) {
        this.hiddenEnemyHint = hiddenEnemyHint;
    }
    ...
    */
    ...
    protected void copyBaseTo(Unit copy) {
        copy.setCurrentHP(getCurrentHP());
        copy.setMaxHP(getMaxHP());
        copy.setActorId(getActorId());
        copy.setStatus(getStatus());
        copy.setHidden(isHidden());
        copy.hiddenAtTurnStart = hiddenAtTurnStart;
        copy.hiddenEnemyHint = hiddenEnemyHint;
    }
}
