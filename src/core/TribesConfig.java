...
public class TribesConfig
{
    ...
    //Knight
    public static final double KNIGHT_ATTACK = 3.5;
    public static final int KNIGHT_DEFENCE = 1;
    public static final int KNIGHT_MOVEMENT = 3;
    public static final int KNIGHT_MAX_HP = 10;
    ...
    static final int CLOAK_POINTS = 40;

    // Dagger
    public static final int DAGGER_ATTACK = 2;
    public static final int DAGGER_DEFENCE = 2;
    public static final int DAGGER_MOVEMENT = 1;
    public static final int DAGGER_MAX_HP = 10;
    public static final int DAGGER_RANGE = 1;
    public static final int DAGGER_COST = 2;
    static final int DAGGER_POINTS = 10;
    ...
    // Juggernaut
    public static final int JUGGERNAUT_ATTACK = 4;
    public static final int JUGGERNAUT_DEFENCE = 4;
    public static final int JUGGERNAUT_MOVEMENT = 2;
    public static final int JUGGERNAUT_MAX_HP = 40;
    public static final int JUGGERNAUT_RANGE = 1;
    public static final int JUGGERNAUT_COST = 0;
    static final int JUGGERNAUT_POINTS = 0;

    // Dinghy
    public static final int DINGHY_ATTACK = 2;
    public static final double DINGHY_DEFENCE = 0.5;
    public static final int DINGHY_MOVEMENT = 2;
    public static final int DINGHY_RANGE = 1;
    public static final int DINGHY_COST = 0;
    static final int DINGHY_POINTS = 0;

    // Pirate
    public static final int PIRATE_ATTACK = 2;
    public static final int PIRATE_DEFENCE = 2;
    public static final int PIRATE_MOVEMENT = 2;
    public static final int PIRATE_MAX_HP = 10;
    public static final int PIRATE_RANGE = 1;
    public static final int PIRATE_COST = 0;
    static final int PIRATE_POINTS = 0;

    // Raft
    public static final int RAFT_ATTACK = 0;
    public static final int RAFT_DEFENCE = 1;
    public static final int RAFT_MOVEMENT = 2;
    public static final int RAFT_RANGE = 0;
    ...
    // LumberHut
    static final int LUMBER_HUT_COST = 3;
    ...
    public static final int PORT_TRADE_DISTANCE = 6; //Allows up to five water tiles between ports plus the destination-port step.

    // Market
    static final int MARKET_COST = 5;
    static final int MARKET_BONUS = 0;

    // Embassy
    public static final int EMBASSY_COST = 5;
    public static final int EMBASSY_STARS = 2;
    public static final int EMBASSY_TREATY_STARS = 4;
    ...
    public static final int TEMPLE_TURNS_TO_SCORE = 2;
    public static final int[] TEMPLE_POINTS = new int[]{100, 100, 100, 100, 100};

    //Resources
    static final int ANIMAL_COST = 2;
    static final int FISH_COST = 2;
    static final int STARFISH_COST = 0;
    static final int FRUIT_COST = 2;
    static final int ANIMAL_POP = 1;
    static final int FISH_POP = 1;
    static final int STARFISH_STARS = 8;
    static final int FRUIT_POP = 1;

    // ROAD
    public static final int ROAD_COST = 3;
    public static final int BRIDGE_COST = 5;
    ...
    public static final double TECH_DISCOUNT_VALUE = 1.0 / 3.0;
    public static final int TECH_TIER_POINTS = 100;

    /* TRIBES */
    public static final int INITIAL_STARS = 5;//fallback only
    ...
    // MAP
    public static final int[] DEFAULT_MAP_SIZE = new int[]{-1, 11, 14, 16, 18, 20, 30, 30};
