...
public class TechView extends JComponent {
    ...
    // TODO: search functionality (i.e. "market -> Trade research")
    TechView(Game game, ActionController ac, InfoView infoView)
    {
        ...
        buttons.setPreferredSize(new Dimension(GUI_SIDE_PANEL_WIDTH - 24, GUI_TECH_PANEL_FULL_SIZE));
...
//            techEffects[i] = effect;
        ...
        buttons.add(Box.createVerticalGlue(), gbc);
