...
public class GameplayStats {
    ...
    private final String[] stats = new String[]{"Production", "Num cities", "Tiles owned",
            ...
            "Num units CATAPULT", "Num units KNIGHT", "Num units MIND_BENDER", "Num units RAFT", "Num units SCOUT", "Num units BOMBER", "Num units SUPERUNIT",
            "Num units CLOAK", "Num units DAGGER", "Num units RAMMER", "Num units JUGGERNAUT", "Num units DINGHY", "Num units PIRATE",
            ...
            "Num buildings MARKET", "Num buildings LUMBER_HUT", "Num buildings SAWMILL", "Num buildings EMBASSY",
    };
    ...
    private final List<Types.TECHNOLOGY> navalTechs = Arrays.asList(FISHING, RAMMING, SAILING, NAVIGATION, AQUATISM);
    ...
    private final String[] actionSubtypes = new String[]{
            ...
            "Build MARKET", "Build LUMBER_HUT", "Build SAWMILL", "Build EMBASSY",
            "Research", "Research farm", "Research mountain", "Research naval", "Research range", "Research roads",
    };
    ...
    private void logSubAction(Action act, int turn)
    {
        ...
        if (!actionSubtypeCount.containsKey(key) || !actionSubtypeCountTurn.containsKey(key)) {
            throw new IllegalStateException("Unknown action subtype key: " + key);
        }
