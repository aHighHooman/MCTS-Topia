...
public class LinearRegression {
    private double intercept = 0.0, slope = 0.0;
    private double r2 = 0.0;
    private double svar0 = 0.0, svar1 = 0.0;

    /**
     * Performs a linear regression on the data points {@code (y[i], {0 .. y.length})}.
     *
     ...
     * @throws IllegalArgumentException if the lengths of the two arrays are not equal
     */
    private void doRegression(double[] x, double[] y){
